...
export default function EventForm () {
    ...
    const onSubmit = async() => {
        ...
        const err1 = await dispatch(thunkAddImageEvent(imageEvent,))
        if (err.id) {
    ...
    return (
        <div id="divholdingeverythingcreateevent">
            ...
            {/* <h4 className="allh4tagsaboveinputscreateevent">Max number of people that can attend this event?</h4>
            <input type="number"
